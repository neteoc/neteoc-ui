...
exports.sendMissionSignupEmail = functions.database.ref('/missions/{missionId}/roster/{userId}')
    ...
    //Subject and text data  
      ...
      html: `<p>Dear${original.displayName}</p><p>You have signed up for a mission. To see more details vist <a href="https://gsdf.neteoc.com/missions/${event.params.missionId}">https://gsdf.neteoc.com/missions/${event.params.missionId}</a></p>`
    }
